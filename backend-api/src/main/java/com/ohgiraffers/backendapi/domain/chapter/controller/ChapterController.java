...
public class ChapterController {
    ...
    @Operation(summary = "챕터 등록", description = "JSON 파일을 업로드하여 챕터를 생성. 메타데이터 미입력 시 파일에서 자동 추출.")
    ...
    @Operation(summary = "챕터 수정", description = "챕터의 파일 또는 메타데이터를 수정. 파일 변경 시 'isEmbedded' 상태가 초기화됨.")
    ...
    @Operation(summary = "챕터 삭제", description = "챕터와 연관된 파일 및 데이터를 영구 삭제.")
    ...
    @Operation(summary = "챕터 조회 (뷰어용)", description = "챕터의 상세 정보와 함께 파일에 저장된 본문 내용(JSON)을 반환.")
